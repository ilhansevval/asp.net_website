<html lang="tr">
  ...
  <body bgcolor="#747474">
    ...
    <div class="boxa"> 
     <br><br><br>
    <div class="videoa"><iframe width="700" height="400" src="https://www.youtube.com/embed/t7Ag9Q8eLOw" frameborder="0" 
	...
	<div class="mesaj">
            ...
            <form action="videoa.asp" method="POST">
            <tr>
            <td width="350">
            </td>
	    ...
	    <br><br><br>
            ...
            <form method="get" action="video.asp">
   ...
   <%
	if request.servervariables("REQUEST_METHOD")="POST" then
		...
		sql="INSERT INTO yorum1(isim,yorum,tarih) VALUES('" & ad & "','" & mesaj & "','" & tarih & "')"
		conn.Execute sql

		conn.Close
		set conn=Nothing
		response.redirect "videoa.asp"
