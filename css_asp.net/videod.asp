<html lang="tr">
  ...
  <body bgcolor="#747474">
    ...
    <header>
      ...
      <div class="boxa"> 
          ...
          <div class="videob"><iframe width="650" height="370" src="https://www.youtube.com/embed/yVjmuNj5TdA" 
    	...
    	<div class="mesaj">
           ...
           <form action="videod.asp" method="POST">
            <tr>
            <td width="350">
            </td>
 ...
 <%
	if request.servervariables("REQUEST_METHOD")="POST" then
		...
		sql="INSERT INTO yorum4(isim,yorum,tarih) VALUES('" & ad & "','" & mesaj & "','" & tarih & "')"
		conn.Execute sql

		conn.Close
		set conn=Nothing
		response.redirect "videod.asp"
