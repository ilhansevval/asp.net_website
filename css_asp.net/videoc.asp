<html lang="tr">
    ...
    <header>
     ...
     <div class="SideBar">
      ...
      <div class="boxa"> 
          ...
          <div class="videob"><iframe width="650" height="370" src="https://www.youtube.com/embed/1KapUgnM4ks" 
    	  ...
    	  <div class="mesaj">
            ...
            <form action="videoc.asp" method="POST">
            <tr>
            <td width="350">
            </td>
 ...
 <%
	if request.servervariables("REQUEST_METHOD")="POST" then
		...
		sql="INSERT INTO yorum3(isim,yorum,tarih) VALUES('" & ad & "','" & mesaj & "','" & tarih & "')"
		conn.Execute sql

		conn.Close
		set conn=Nothing
		response.redirect "videoc.asp"
