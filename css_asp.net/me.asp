<html lang="tr">
  ...
  <body bgcolor="#747474">
    ...
    <div class="boxd">
      <div class="baslık"><i>Şevval İLHAN</i><br><br><br></div>
	  
      <div class="me">
	  
        <img width="600" height="400" src="img.jpg"><br><br><br>
            ...
            <br><br><br>
            <td> <b>Mesajınız: </b><br>
            <textarea name="message" rows="10" cols="70"  placeholder="YORUMUNUZ..."></textarea><br><br></td>
...
<%
	if request.servervariables("REQUEST_METHOD")="POST" then
		...
		'verikaydet.Open "yorumlar", conn,1,3
		'verikaydet.addnew
		'verikaydet("isim")=ad
		'verikaydet("yorum")=mesaj
		'verikaydet("tarih")=now()
		'verikaydet.Update
		
		sql="INSERT INTO yorumlar(isim,yorum,tarih) VALUES('" & ad & "','" & mesaj & "','" & tarih & "')"
		conn.Execute sql
