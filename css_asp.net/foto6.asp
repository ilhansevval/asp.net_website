<html lang="tr">
  ...
  <body bgcolor="#747474">
    ...
    <div class="boxd">
      <div class="photo"><img src="foto6.JPG"><br>
      <br><br><br>
      
          <form action="foto6.asp" method="POST">
            <tr>
            <td width="350">
            </td>
...
<%
	if request.servervariables("REQUEST_METHOD")="POST" then
		...
		sql="INSERT INTO yorumlar6(isim,yorum,tarih) VALUES('" & ad & "','" & mesaj & "','" & tarih & "')"
		conn.Execute sql

		conn.Close
		set conn=Nothing
		response.redirect "foto6.asp"
