<html lang="tr">
  ...
  <body bgcolor="#747474">
    ...
    <header>
     ...
     <div class="SideBar">
          ...
          <div class="videob"><iframe width="650" height="370" src="https://www.youtube.com/embed/8rY5CaCBc_g" 
    	...
    	<div class="mesaj">
            ...
            <form action="videob.asp" method="POST">
            <tr>
            <td width="350">
            </td>
 ...
 <%
	if request.servervariables("REQUEST_METHOD")="POST" then
		...
		sql="INSERT INTO yorum2(isim,yorum,tarih) VALUES('" & ad & "','" & mesaj & "','" & tarih & "')"
		conn.Execute sql

		conn.Close
		set conn=Nothing
		response.redirect "videob.asp"
